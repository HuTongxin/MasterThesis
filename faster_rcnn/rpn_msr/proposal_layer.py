...
def proposal_layer(rpn_cls_prob_reshape, rpn_bbox_pred, im_info, cfg_key, 
    ...
    scores = rpn_cls_prob_reshape[:, _num_anchors:, :, :]  # [1,25,W,H]
    ...
    height, width = scores.shape[-2:]  # size of thi image
    ...
    # print shifts.shape # get shifts.shape(W*H, 4)
    ...
    # print bbox_deltas.shape # get bbox_deltas.shape(W*H*A, 4)
    ...
    # print(blob.shape) # get [2000,5],[533,5],[224,5],[114,5],...
    return blob, scores
