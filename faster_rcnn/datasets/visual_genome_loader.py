...
class visual_genome(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        #print(osp.join(cfg.IMG_DATA_DIR, self.annotations[index]['path']))
        img = cv2.imread(osp.join('/home/hutong/tmp/data/VG_100K', self.annotations[index]['path']))
        if img is None:
            img = cv2.imread(osp.join('/home/hutong/tmp/data/VG_100K_2', self.annotations[index]['path']))
